...
# backend=None nothing is serialized, so it raises ConfigurationError.
...
- [Backend Guide](backends/README.md) - Implement custom storage backends
- [Serializer Guide](serializers/README.md) - Choose the right data format
