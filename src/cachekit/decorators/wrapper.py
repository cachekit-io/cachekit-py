    ...
    **kwargs: Any,
    ...
    Args:
        ...
        tenant_extractor: Optional tenant ID extractor for multi-tenant encryption.
                         ...
                         the call runs uncached. There is no fallback to a shared key.
    ...
    # references via ObjectCache and never serializes, which is why the guard
    # above refuses explicit encryption there. An env-detected key (encryption=None) is
    # not refused and goes unused. Documented in docs/features/zero-knowledge-encryption.md.
